...
ALLOWED_CODES_PARAM = "one_click_language_switcher.allowed_lang_codes"
...
class ResConfigSettings(models.TransientModel):
    ...
    one_click_language_allowed_lang_ids = fields.Many2many(
        "res.lang",
        string="Languages offered by the switcher",
        domain=[("active", "=", True)],
        help="Languages the One-Click Language Switcher offers to users. "
    ...
    def get_values(self):
        ...
        codes = self.env["res.users"]._one_click_language_allowed_codes()
        ...
        res["one_click_language_allowed_lang_ids"] = [fields.Command.set(langs.ids)]
        return res
    ...
    def set_values(self):
        ...
        """
        super().set_values()
        codes = ",".join(sorted(self.one_click_language_allowed_lang_ids.mapped("code")))
